<x-admin-layout>
    <div class="container py-12">
        <section class="grid md:grid-cols-5 gap-6 text-white">
            <a href="{{route('admin.orders.index'). "?status=6"}}" class="bg-blue-500 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">{{ $reviewing }}</p>
                <p class="uppercase text-center">Para revisar</p>
        ...
        @if ($orders->count())          
            <section class="bg-white shadow-lg rounded-lg px-12 py-8 mt-12 text-gray-700">
                ...
                <ul>
                    ...
                    @empty
                        <p class="text-center text-2xl">No hay ninguna orden aún 😢</p>
                    @endforelse
                </ul>
            </section>
        @else
